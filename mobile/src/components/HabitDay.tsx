import { TouchableOpacity as TO, Dimensions, TouchableOpacityProps } from 'react-native';
...
export function HabitDay({ amount = 0, completed = 0, date, ...props }: Props) {

    const amountAccomplishedPercentage = amount > 0 ?
